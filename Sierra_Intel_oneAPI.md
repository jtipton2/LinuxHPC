...
> [!IMPORTANT]
> The trilinos third party library install also failed on a compute note compile attempt with 'X11/Xlib.h' file not found.
> The solution was to first install `dnf install libX11-devel.x86_64`.  Afterward, I then have `/usr/include/X11/Xlib.h`.
...
* Available architecture optimizations for Intel compilers can be found in the boost directory:
```
/data/software/Sierra/5.22_test/build/distro/code/Nbtools/boost/tools/build/v2/tools/oneapi-linux.jam

    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>            : $(oneapi64_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>generic_x86 : $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>fat_x86     : -axAVX -msse2 -diag-disable 381,cpu-dispatch,openmp $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>nehalem     : -xSSE4.2      -diag-disable 381,10121,openmp $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>sandybridge : -xAVX         -diag-disable 381,10121,openmp $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>haswell     : -xCORE-AVX2   -diag-disable 381,10121,openmp $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>skylake     : -xCORE-AVX512 -diag-disable 381,10121,openmp $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>sapphirerapids : -xCORE-AVX512 -diag-disable 381,10121,openmp $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>knl         : -xMIC-AVX512  -diag-disable 381,10121,openmp $(generic_x86_flags) ;
    flags oneapi-linux.compile OPTIONS $(condition)/<architecture>cray        : $(oneapi64_flags) ;
    flags oneapi-linux.link    OPTIONS $(condition)/<architecture>knl         : -xMIC-AVX512 ;
```
...
```
* Third, I note that the actual compiling of the Sierra binaries uses the appropriate flags (e.g. `-O2 -fp-model precise -xAVX -diag-disable 381,10121,openmp`):
```
[tvj@bernie build]$ grep -F "[1/" build.log -n
48609:[1/43644] sierra_distcc_exec "/mnt/home/tvj/software/spack/var/spack/environments/sierra522mod/.spack-env/view/compiler/2024.1/bin/icpx" -c -x c++ -std=c++17 -Wall -Wignored-qualifiers -Wno-inconsistent-missing-override -Wno-mismatched-tags -Wno-undefined-var-template -Wno-unused-local-typedef -Wno-unused-private-field -Wno-deprecated-builtins -Wno-vla-cxx-extension -O2 -fp-model precise -xAVX -diag-disable 381,10121,openmp -no-fma  -DADDC_ -DBUILT_IN_SIERRA -DBuild64 -DEIGEN_DONT_PARALLELIZE -DEXODUS_SUPPORT -DFMT_SUPPORT -DFORTRAN_ONE_UNDERSCORE -DLC_FLINK -DMPICH_SKIP_MPICXX -DNDEBUG -DSIERRA_DLOPEN_ENABLED -DSIERRA_USE_MKL_LAPACK -DSTK_BUILT_FOR_SIERRA -DSTK_BUILT_WITH_BJAM -DSTK_HIDE_DEPRECATED_CODE -DSTK_SHOW_DEPRECATED_WARNINGS -DUNDERSCORE -I""/mnt/home/tvj/software/spack/var/spack/environments/sierra522mod/.spack-env/view/mpi/2021.12/include"" -I""/mnt/home/tvj/software/spack/var/spack/environments/sierra522mod/.spack-env/view/mpi/2021.12/include/mpi"" -I"/data/software/Sierra/5.22_test/build/distro/code/FETI-DP" -I"/data/software/Sierra/5.22_test/build/distro/code/FETI-DP/include" -I"/data/software/Sierra/5.22_test/build/distro/code/FETI-DP/src" -I"/data/software/Sierra/5.22_test/build/distro/code/Sierra/lapack" -I"/data/software/Sierra/5.22_test/build/distro/code/TPLs_src/SparsePack/include" -I"/data/software/Sierra/5.22_test/build/distro/code/TPLs_src/eigen" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/boost-1.77.0-vbo4l7u4l25f7f64jyez3cqfhost3ka5/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/fmt-10.2.1-igv7ytif6i4karxqiito274w6i2nu4i3/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/hdf5-1.12.3-qmep5jugjsfb3yfou7p5zgkqagu62gyx/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/metis-5.1.0-44buctojaidn4gvbim63w3rtj4vv4dlt/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/netcdf-c-4.9.2-ht5v5kxzbsyep7vywrb377g6cuqq235b/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/parallel-netcdf-1.13.0-ujte6hdg4zbx6adodukrsbozcbg2mlky/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/parmetis-4.0.3-pxixlrxvx7ejojnrcp7rozsikaxsawtp/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/scotch-6.0.4-x6vbmodnyswuxv6xd4yyqflerujpro4t/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/superlu-5.2.1-sdptf7nt7dsz44u5kpc5aebuyjshsssp/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/trilinos-2024.07.08-qoqugp7q4a65owoqwsqbaih4ymkg6eq2/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/umfpack-5.1.0-dd3ums2zr3onauccoevusahghnojmvdv/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/y12m-1.0.0-elblxz4zve57rfdulamzxxkcfjl6obrh/include" -I"/data/software/Sierra/5.22_test/build/distro/code/objs/tpls/spack/spack/__spack_path_placeholder__/__spack_path_placeholder__/__/linux-rhel8-sandybridge/oneapi-2024.1.0/zlib-1.2.13-vicjxnfx5dy7efyx6dbwxfqndtv7tcv6/include" -I"/data/software/Sierra/5.22_test/build/distro/code/seacas" -I"/data/software/Sierra/5.22_test/build/distro/code/seacas/libraries/aprepro_lib" -I"/data/software/Sierra/5.22_test/build/distro/code/seacas/libraries/exodus/include" -I"/data/software/Sierra/5.22_test/build/distro/code/seacas/libraries/exodus/sierra" -I"/data/software/Sierra/5.22_test/build/distro/code/seacas/libraries/ioss/src" -I"/data/software/Sierra/5.22_test/build/distro/code/seacas/libraries/ioss/src/elements" -I"/data/software/Sierra/5.22_test/build/distro/code/seacas/libraries/ioss/src/init" -I"/data/software/Sierra/5.22_test/build/distro/code/stk/stk_util" -I"/mnt/home/tvj/software/spack/var/spack/environments/sierra522mod/.spack-env/view/mkl/2024.2/include" -c -o "/data/software/Sierra/5.22_test/build/distro/code/objs/apps/FETI-DP/votd/oneapi-linux-2024.1.0/release/address-model-64/architecture-sandybridge/lapack-mkl/mpi-intel/runtime-link-shared/feti_constants.o" "/data/software/Sierra/5.22_test/build/distro/code/FETI-DP/src/feti_constants.C" -MMD -MF /data/software/Sierra/5.22_test/build/distro/code/objs/apps/FETI-DP/votd/oneapi-linux-2024.1.0/release/address-model-64/architecture-sandybridge/lapack-mkl/mpi-intel/runtime-link-shared/feti_constants.o.d -MT /data/software/Sierra/5.22_test/build/distro/code/objs/apps/FETI-DP/votd/oneapi-linux-2024.1.0/release/address-model-64/architecture-sandybridge/lapack-mkl/mpi-intel/runtime-link-shared/feti_constants.o
[tvj@bernie build]$ 
```
